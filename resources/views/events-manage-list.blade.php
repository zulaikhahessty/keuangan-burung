...
<head>
  ...
  <style>
    /* Sama dengan halaman SEMARFIN Event */
...
<div class="flex min-h-screen">
  ...
  {{-- Sidebar — sama dengan halaman SEMARFIN Event --}}
  <aside id="sidebar"
          ...
          <div class="p-0 overflow-x-auto">
            <table class="w-full text-sm">
              ...
              <tbody class="divide-y divide-slate-200">
                  ...
                  <tr class="hover:bg-slate-50 transition-colors duration-150">
                    ...
                    <td class="px-6 py-4">
                      <div class="flex items-center justify-center gap-2 flex-wrap">
                        <a href="{{ route('events.manage', $e) }}"
                           class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-indigo-50 text-indigo-700 border border-indigo-200 hover:bg-indigo-100 transition">
                          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v4m8-4v4m-4 4v.01M12 21.01V12h9v5a2 2 0 0 1-2 2H7"/></svg>
                          Kelola
                        </a>
                      </div>
                    </td>
                ...
                @empty
                  <tr>
                    <td colspan="4" class="px-6 py-8 text-center text-slate-500">Belum ada event.</td>
                  </tr>
                @endforelse
              </tbody>
            </table>
...
{{-- Script untuk Offcanvas Mobile — sama dengan halaman SEMARFIN Event --}}
<script>
